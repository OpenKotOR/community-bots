...
4. Run one bot at a time with one of:
   ...
   - `corepack pnpm dev:hk` (see `docs/guides/hk-86.md`; reaction panels use `data/hk-bot/reaction-role-panels.json` — start from `apps/hk-bot/reaction-role-panels.example.json`; `/designations reactions help` in Discord prints setup steps; static Discord bots hub when deployed: https://openkotor.github.io/bots/hk86)
