...
| Doc | Use when |
|-----|----------|
| [trask-citation-stack-closeout-2026-05-24.md](../solutions/tooling-decisions/trask-citation-stack-closeout-2026-05-24.md) | Citation + quality-bar arc **PR #33–#84** and `pnpm trask:gate` ladder |
