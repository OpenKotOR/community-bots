...
- Default Trask synthesis to **free LLM providers** (`TRASK_LLM_PROFILE=free`, `openrouter/free`); do not assume `OPENAI_API_KEY`, local LLM, or paid models unless explicitly requested.
