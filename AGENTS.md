...
- **Trask citation modules (PR #33–#48):** `citation-markers.ts`, `research-answer-split.ts`, `query-anchor.ts`, `grounded-evidence.ts` (compose), `discord-reply-format.ts` (brief embed). Offline preflight: **`pnpm trask:gate`** (build + full + CI optimize-measure); **composite_score** floor **165**. See **`docs/solutions/tooling-decisions/trask-citation-stack-closeout-2026-05-24.md`** and **`trask-citation-module-architecture-2026-05-24.md`**.
