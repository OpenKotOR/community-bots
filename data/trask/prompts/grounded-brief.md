...
Use ONLY the numbered evidence passages. Cite claims inline with [n] in the message body. Prefer 3–5 distinct citations when the evidence supports it; never fewer than 2.
Choose citations deliberately: primary docs or project repositories for definitions, community/reference pages for distribution or usage notes, and indexed Discord/community evidence only when it is directly relevant to the user's wording or a named community figure.
