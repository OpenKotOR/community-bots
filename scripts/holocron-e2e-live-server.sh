...
PRESERVE_TRASK_INDEXER_BASE_URL="${TRASK_INDEXER_BASE_URL-}"
PRESERVE_TRASK_WEB_RESEARCH_LOCAL_CHROMA="${TRASK_WEB_RESEARCH_LOCAL_CHROMA-}"
PRESERVE_TRASK_WEB_RESEARCH_DDG_FALLBACK="${TRASK_WEB_RESEARCH_DDG_FALLBACK-}"
...
if [[ -n "$PRESERVE_TRASK_INDEXER_BASE_URL" ]]; then
  export TRASK_INDEXER_BASE_URL="$PRESERVE_TRASK_INDEXER_BASE_URL"
fi
if [[ -n "$PRESERVE_TRASK_WEB_RESEARCH_LOCAL_CHROMA" ]]; then
  export TRASK_WEB_RESEARCH_LOCAL_CHROMA="$PRESERVE_TRASK_WEB_RESEARCH_LOCAL_CHROMA"
fi
if [[ -n "$PRESERVE_TRASK_WEB_RESEARCH_DDG_FALLBACK" ]]; then
  export TRASK_WEB_RESEARCH_DDG_FALLBACK="$PRESERVE_TRASK_WEB_RESEARCH_DDG_FALLBACK"
fi
